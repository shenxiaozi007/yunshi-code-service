...
return new class extends Migration
{
    ...
    {
        Schema::create('ycrm_adm_role', function (Blueprint $table) {
            $table->comment('CRM-角色');
            $table->increments('id');
            $table->string('role_no', 128)->default('')->comment('角色编号')->unique();
            ...
            $table->unsignedInteger('edit_admin_id')->default(0)->comment('最后编辑此角色的管理员的id');
    ...
    {
        Schema::dropIfExists('ycrm_adm_role');
    }
};
